...
public class BlitAndSwapColorPass : ScriptableRenderPass
{
    ...
    public void Setup(Material mat)
    {
        ...
        //The pass will read the current color texture.
        //That needs to be an intermediate texture.
        ...
        //This has a performance cost so don't set this if you don't need it.
        //It's good practice to set it here and not from the RenderFeature.
        //This way, the pass is selfcontaining and you can use it to directly enqueue the pass from a monobehaviour without a RenderFeature.
    ...
    public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
    {
        ...
        //FrameData allows to get and set internal pipeline buffers.
        //Here we update the CameraColorBuffer to the texture that we just wrote to in this pass. 
