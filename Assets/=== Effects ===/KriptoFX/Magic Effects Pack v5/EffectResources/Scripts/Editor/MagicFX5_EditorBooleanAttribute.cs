...
public class ConditionalHidePropertyDrawer : PropertyDrawer
{
    ...
    private bool GetConditionalSourceField(SerializedProperty property, ShowIfAttribute condHAtt)
    {
        ...
        {
            string warning = "ConditionalHideAttribute: The Boolean field is not found [" + condHAtt.ConditionalSourceField + "] en " + property.propertyPath;
            warning += " Make sure to specify the name of the conditional field correctly.";
