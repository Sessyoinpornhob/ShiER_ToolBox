	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float3 WorldPosition158_g61277 = worldPosValue184_g61277;
				float4 ase_screenPosNorm = ScreenPos / ScreenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 ScreenUV183_g61277 = (ase_screenPosNorm).xy;
				float2 ScreenUV158_g61277 = ScreenUV183_g61277;
				...
				float3 WorldNormal158_g61277 = worldNormalValue185_g61277;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float3 temp_output_15_0_g61277 = ase_worldViewDir;
				float3 WorldView158_g61277 = temp_output_15_0_g61277;
				float3 temp_output_14_0_g61277 = _IndirectSpecularColor;
				float3 SpecColor158_g61277 = temp_output_14_0_g61277;
				float temp_output_18_0_g61277 = _IndirectSpecularSmoothness;
				float Smoothness158_g61277 = temp_output_18_0_g61277;
				float3 localAdditionalLightsSpecular14x158_g61277 = AdditionalLightsSpecular14x( WorldPosition158_g61277 , ScreenUV158_g61277 , WorldNormal158_g61277 , WorldView158_g61277 , SpecColor158_g61277 , Smoothness158_g61277 );
				...
				float3 temp_output_575_0_g1 = ( localAdditionalLightsSpecular14x158_g61277 + temp_output_574_0_g1 );
				...
				float3 WorldPosition149_g61278 = worldPosValue184_g61278;
				float2 ScreenUV183_g61278 = (ase_screenPosNorm).xy;
				float2 ScreenUV149_g61278 = ScreenUV183_g61278;
				float3 worldNormalValue185_g61278 = WorldNormalTangent1160_g1;
				float3 WorldNormal149_g61278 = worldNormalValue185_g61278;
				float3 localAdditionalLightsHalfLambert14x149_g61278 = AdditionalLightsHalfLambert14x( WorldPosition149_g61278 , ScreenUV149_g61278 , WorldNormal149_g61278 );
				...
				float3 Indirect_Diffuse644_g1 = ( ( ( localAdditionalLightsHalfLambert14x149_g61278 + bakedGI607_g1 ) * _IndirectDiffuse ) * Occlusion435_g1 );
...
ASEEND*/
//CHKSM=77E14D499946C165CE87BC7EEC4195AB2436E2F5