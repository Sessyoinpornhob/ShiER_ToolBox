...
Shader "AmplifyShaderPack/Snow Accumulate"
{
	Properties
	{
		...
		[ASEBegin]_RockAlbedo("Rock Albedo", 2D) = "white" {}
		...
		[ASEEnd]_SnowAmount("Snow Amount", Range( 0 , 2)) = 0.13
...
ASEEND*/
//CHKSM=AFFF18DBEF09B5DC31C4BEF5A6026EA1D230B84F