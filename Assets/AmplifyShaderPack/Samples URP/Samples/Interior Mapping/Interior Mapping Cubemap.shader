...
Shader "AmplifyShaderPack/Interior Mapping Cubemap"
{
	Properties
	{
		...
		[ASEBegin]_RoomCountX("Room Count X", Float) = 4
		...
		[ASEEnd][SingleLineTexture]_Roof("Roof", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 temp_output_28_0_g127 = ( ase_tanViewDir * float3( -1,1,1 ) );
				float3 temp_output_17_0_g127 = ( float3( 1,1,1 ) / temp_output_28_0_g127 );
				float2 appendResult182 = (float2(_RoomCountX , _RoomCountY));
				float2 temp_output_32_0_g127 = ( IN.ase_texcoord8.xy * appendResult182 );
				...
				float3 temp_output_31_0 = (texCUBElod( _InteriorCube, float4( appendResult121_g127, 0.0) )).rgb;
				...
				float3 Emission85 = ( ( ( temp_output_25_0 * temp_output_31_0 ) * round( (temp_output_39_0_g127).y ) ) * _EmissiveIntensity );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 temp_output_17_0_g127 = ( float3( 1,1,1 ) / temp_output_28_0_g127 );
				float2 appendResult182 = (float2(_RoomCountX , _RoomCountY));
				float2 temp_output_32_0_g127 = ( IN.ase_texcoord7.xy * appendResult182 );
				float3 appendResult29_g127 = (float3(( ( frac( temp_output_32_0_g127 ) * float2( 2,-2 ) ) - float2( 1,-1 ) ) , -1.0));
				float3 break19_g127 = ( abs( temp_output_17_0_g127 ) - ( temp_output_17_0_g127 * appendResult29_g127 ) );
				float3 temp_output_30_0_g127 = ( ( min( min( break19_g127.x , break19_g127.y ) , break19_g127.z ) * temp_output_28_0_g127 ) + appendResult29_g127 );
				float3 break120_g127 = temp_output_30_0_g127;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 temp_output_17_0_g127 = ( float3( 1,1,1 ) / temp_output_28_0_g127 );
				float2 appendResult182 = (float2(_RoomCountX , _RoomCountY));
				float2 temp_output_32_0_g127 = ( IN.ase_texcoord5.xy * appendResult182 );
				float3 appendResult29_g127 = (float3(( ( frac( temp_output_32_0_g127 ) * float2( 2,-2 ) ) - float2( 1,-1 ) ) , -1.0));
				float3 break19_g127 = ( abs( temp_output_17_0_g127 ) - ( temp_output_17_0_g127 * appendResult29_g127 ) );
				float3 temp_output_30_0_g127 = ( ( min( min( break19_g127.x , break19_g127.y ) , break19_g127.z ) * temp_output_28_0_g127 ) + appendResult29_g127 );
				float3 break120_g127 = temp_output_30_0_g127;
...
Node;AmplifyShaderEditor.FunctionNode;418;-1654.479,950.4177;Inherit;False;UV Interior Cubemap;-1;;127;22dbe19408af0d14db5aa16670d14906;1,59,0;2;62;FLOAT2;0,0;False;58;FLOAT2;1,1;False;2;FLOAT3;56;FLOAT3;61
...
WireConnection;418;62;187;0
WireConnection;418;58;182;0
ASEEND*/
//CHKSM=97EF0D2AA381C88EAB7CF06D1E47201979A500BA