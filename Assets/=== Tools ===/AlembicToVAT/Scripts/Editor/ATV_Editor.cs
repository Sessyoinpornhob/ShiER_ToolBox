...
{  
    ...
    [MenuItem("Tools/ShiERToolBox/VAT/Alembic to VAT")]
	...
	SerializedObject InitAlembic()
	{
        ...
        var alembicPlayer = parent.gameObject.GetComponent("UnityEngine.Formats.Alembic.Importer.AlembicStreamPlayer");	// 不在全局设置中。
